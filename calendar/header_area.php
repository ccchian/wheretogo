...
<!-- <header class="header_area"> -->
    <!-- <div class=""> -->
        <nav class="navbar navbar-expand-lg navbar-light sticky-top container header_z">
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent" class="anchors">
                <ul class="nav navbar-nav menu_nav ml-auto">
                    <li class="nav-item"><a style="font-size:23px" class="nav-link" href="../index2.php">首頁</a></li>
                    ...
                    <li class="nav-item submenu dropdown  active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item"><a style="font-size:18px" class="nav-link" href="calendar1.php">活動行事曆</a></li>
