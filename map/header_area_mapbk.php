                ...
                <ul class="nav navbar-nav menu_nav ml-auto">
                    ...
                    <li class="nav-item submenu dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item"><a style="font-size:18px" class="nav-link" href="../行事曆.php">活動行事曆</a></li>
                            <li class="nav-item"><a style="font-size:18px" class="nav-link" href="index.php">依地點查詢活動</a></li>
                        </ul>
                    </li>
                    <li class="nav-item" class="anchors"><a style="font-size:22px" class="nav-link" href="../index2.php#s1">聯絡我們</a></li>
                    <?php
                    if (isset($_SESSION['uID'])) {
                        echo '<li class="nav-item"><a style="font-size:22px" class="nav-link" href="../login-system/newActivity.php">建立活動</a></li>';
                        echo '<li class="nav-item"><a style="font-size:22px" class="nav-link" href="../login-system/profile.php">會員資料</a></li>';
